                ...
                {orders.length === 0 ? (
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        {orders.map((order) => (
                            ...
                            >
                                <div className="p-4 sm:p-6 border-b bogray200">
                                    ...
                                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between">
                                        <div className="flex items-centern">
                                            <span className="text-sm mt-2 ml-2">Status:</span>
                                            <span
                                                className={`px-3 py-3 rounded-full text-sm ${order.status === "paid"
                                        ...
                                        <div className="sm:text-right">
                                            <p className="text-sm text-gray-600 mb-1 mr-2">Total Amount</p>
